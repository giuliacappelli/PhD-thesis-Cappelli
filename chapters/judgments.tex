...
The source code for both my experiments, as well as the stimuli used in them, is available here for \href{https://gitlab.pavlovia.org/gcappelli/grammaticality_eng}{English}\sidenote{https://gitlab.pavlovia.org/gcappelli/ grammaticality\_eng} and \href{https://gitlab.pavlovia.org/gcappelli/grammaticality_ita}{Italian}\sidenote{https://gitlab.pavlovia.org/gcappelli/ grammaticality\_ita}. The files can be read directly online, but the code requires PsychoPy to be edited.
...
\subsection{Creation of verb lists} 
