...
\subsection{English} \labsec{eng_judgresult}


\paragraph{Expected gradience} testo

\paragraph{Semantic selectivity} testo

\paragraph{Telicity} testo

\paragraph{Perfectivity} testo

\paragraph{Iterativity} testo

\paragraph{Manner specification} testo

\paragraph{Joint effect of predictors} testo


\subsection{Italian} \labsec{ita_judgresult}
...
\subsection{Observations} \labsec{sumup_judgresult}
