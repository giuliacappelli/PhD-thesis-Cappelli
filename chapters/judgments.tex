...
First of all, a list was made of several transitive English verbs (3 from \textcite[138]{Resnik1993}, 8 from \textcite[33]{Levin1993}, 4 from both papers, and 5 commonly used verbs of my choosing). I further added to the list 10 verbs specified with respect to the manner component (discussed in \nrefsec{predictor_mannspec}), based on my personal opinion as a linguist and person in charge of this study. This resulted in a list containing 30 transitive verbs, reported in \reftab{verbs_engita}.\\
...
Based on the information discussed in \refch{predictors}, I computed the PISA scores for each verb in both lists, and I annotated each verb pair with their telicity and manner specification features (the full details are collected in \refapp{app_predictors}).\\
