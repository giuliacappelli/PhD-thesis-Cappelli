...
telic & imperf & iterative & specified                  & 0.665 & (0.072) \\
atelic & perfective & iterative & specified             & 0.015 & ns \\
atelic & imperf & iterative & specified                 & -0.521 & ns \\
telic & perfective & non-iterative & specified          & 0.904 & 0.002 \\
telic & imperf & non-iterative & specified              & 0.789 & 0.02 \\
atelic & perfective & non-iterative & specified         & -0.455 & ns \\
atelic & imperf & non-iterative & specified             & -0.458 & ns \\
telic & perfective & iterative & unspecified            & 0.289 & ns \\
telic & imperf & iterative & unspecified                & 0.297 & ns \\
atelic & perfective & iterative & unspecified           & 0.454 & ns \\
atelic & imperf & iterative & unspecified               & 0.407 & ns \\
telic & perfective & non-iterative & unspecified        & 0.204 & ns \\
telic & imperf & non-iterative & unspecified            & -0.03 & ns \\
atelic & perf & non-iterative & unspecified             & 0.213 & ns \\
atelic & perfective & non-iterative & unspecified       & 0.317 & ns \\
\end{tabular}
\end{table}
...
The verb \textit{to cut} has a (normalized between 0 and 1) Behavioral PISA score of 0.356, which would call for a similar normalized acceptability judgments at about one-third of the 0-1 scale. However, the participants to the experiment provided an average rating of 0.286, which is substantially lower than expected based on Behavioral PISA alone. The model, seeing an atelic, iterative input with a not-too-low Behavioral PISA score, all features of a good candidate for object drop, predictably assigns to such an input a sensible, theory-abiding rating of 0.745 (i.e. a 74.5\% probability of yielding an implicit object output).\\
On the contrary, all the target stimuli with the verb \textit{to steal}

% sps minima, quindi giudizio pure deve essere minimo, ma la gente dice alto perché in genere non importa cosa uno rubi? rifletterci.


\paragraph{Italian} testo

% adj R squared totale
% Pearson for each aspectual type (+ Pearson generale)
% individual squared error (citare appendice nuova!)

% \reftab{tab_adjrsq_ita}
% \reftab{tab_pearson_ita}

% total Pearson	r= 0.692	p= 0.000

% telic	r= 0.640	p= 0.000
% atelic	r= 0.374	p= 0.001
% perf	r= 0.631	p= 0.000
% imperf	r= 0.730	p= 0.000
% iter	r= 0.692	p= 0.000
% noiter	r= 0.694	p= 0.000
% spec	r= 0.749	p= 0.000
% nospec	r= 0.470	p= 0.000

% telic_perf_iter_spec	r= 0.329	p= 0.427
% telic_imperf_iter_spec	r= 0.630	p= 0.094
% atelic_perf_iter_spec	r= 0.466	p= 0.352
% atelic_imperf_iter_spec	r= 0.022	p= 0.966
% telic_perf_noiter_spec	r= 0.558	p= 0.150
% telic_imperf_noiter_spec	r= 0.478	p= 0.231
% atelic_perf_noiter_spec	r= 0.099	p= 0.852
% atelic_imperf_noiter_spec	r= 0.282	p= 0.588
% telic_perf_iter_nospec	r= 0.486	p= 0.514
% telic_imperf_iter_nospec	r= 0.751	p= 0.249
% atelic_perf_iter_nospec	r= 0.429	p= 0.164
% atelic_imperf_iter_nospec	r= 0.436	p= 0.157
% telic_perf_noiter_nospec	r= 0.552	p= 0.448
% telic_imperf_noiter_nospec	r= 0.775	p= 0.225
% atelic_perf_noiter_nospec	r= 0.419	p= 0.175
% atelic_imperf_noiter_nospec	r= 0.404	p= 0.193
