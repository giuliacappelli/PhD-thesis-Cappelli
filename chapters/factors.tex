...
\begin{itemize}
    ...
    \item in contrast with "result" % per indicare, sostanzialmente, activity vs accomplishment/achievement (AL diceva che poteva essere collineare con telicity!)
\end{itemize}
