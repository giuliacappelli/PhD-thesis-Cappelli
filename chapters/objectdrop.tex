...
\textcite[122]{vanvalinlapolla1997syntax} coined the term "inherent arguments" to describe the indefinite implicit objects occurring with activity verbs, based on the idea that they denote a facet of the meaning of the verb, characterizing the action itself rather than a participant.
...
% TROVARE UN POSTO A QUESTA CONSIDERAZIONE IN QUESTO PARAGRAFO
...
% *Gillon (2012: 314)*
% CON QUESTO, CHIUDERE L'INTRODUZIONE E LASCIARE IL PASSO ALLE DUE SEZIONI SUCCESSIVE!
